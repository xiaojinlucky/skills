...
- Package: omicverse
- Language: Python
- Function: `omicverse.single.autoResolution`
- Source: https://omicverse.readthedocs.io/en/latest/api/reference/omicverse.single.autoResolution.html
...
```text
omicverse.single. autoResolution ( adata , resolutions = None , * , method = 'bootstrap-ari' , n_subsamples = 5 , subsample_frac = 0.8 , use_null_correction = True , n_null_subsamples = 3 , null_seed = 42 , null_layer = None , gamma_min = 0.05 , gamma_max = 3.0 , n_partitions = 30 , min_clusters = 3 , key_added = 'leiden' , random_state = 0 , verbose = True )
```
