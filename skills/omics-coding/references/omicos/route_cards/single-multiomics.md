...
- Source raw material: `../raw_skills/single-multiomics/SOURCE.md`
- Domain: `single_cell_multiomics`
- Route role: `route_card`
- Object route: `paired_or_unpaired_multiome_objects`
...
Modality pairing, feature mapping, and integration objective must be explicit.
