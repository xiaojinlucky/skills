...
- Source raw material: `../raw_skills/fm-foundation-models/SOURCE.md`
- Domain: `foundation_models`
- Route role: `candidate_reminder`
- Object route: `anndata_or_cells_for_embedding`
- Primary authority: OmicVerse function docs and model official docs
...
Foundation model outputs need version, checkpoint, species, and training-domain checks.
