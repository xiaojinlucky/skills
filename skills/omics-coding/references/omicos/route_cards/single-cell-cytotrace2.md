...
- Source raw material: `../raw_skills/single-cell-cytotrace2/SOURCE.md`
- Domain: `developmental_potency`
- Route role: `route_card`
- Object route: `single_cell_anndata`
- Primary authority: OmicVerse function docs and CytoTRACE2 official docs
...
Potency score is a model estimate and species/preprocessing dependent.
