...
- Source raw material: `../raw_skills/reference-label-transfer/SOURCE.md`
- Domain: `reference_label_transfer`
- Route role: `route_card`
- Object route: `reference_anndata_plus_query_anndata`
- Primary authority: OmicVerse function docs
...
Reference labels, shared features, and transfer backend must match the biological question.
