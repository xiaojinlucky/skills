# CellFateGenie pseudotime gene analysis

- Source raw material: `../raw_skills/single-cellfate-analysis/SOURCE.md`
- Domain: `cell_fate`
- Route role: `candidate_reminder`
- Object route: `pseudotime_or_lineage_anndata`
- Primary authority: OmicVerse function docs and method docs
...
Lineage and pseudotime assumptions must be verified before gene trend claims.
