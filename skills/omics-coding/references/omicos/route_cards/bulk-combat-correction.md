...
- Source raw material: `../raw_skills/bulk-combat-correction/SOURCE.md`
- Domain: `bulk_batch_correction`
- Route role: `route_card`
- Object route: `bulk_expression_matrix`
- Primary authority: OmicVerse/SCOP function docs and pyComBat official docs if used
...
Batch correction can remove biology; require design columns before running.
