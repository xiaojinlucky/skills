...
- Source raw material: `../raw_skills/single-cell-kb-alignment/SOURCE.md`
- Domain: `single_cell_fastq_quantification`
- Route role: `route_card`
- Object route: `single_cell_fastq_reference`
- Primary authority: OmicVerse function docs and kallisto|bustools official docs
...
Chemistry, reference, and barcode handling determine count matrix validity.
