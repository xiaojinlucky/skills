...
- Source raw material: `../raw_skills/single-cell-sctour-trajectory/SOURCE.md`
- Domain: `trajectory`
- Route role: `route_card`
- Object route: `raw_count_anndata`
- Primary authority: OmicVerse function docs and scTour official docs
...
Use only when scTour assumptions match raw-count input and trajectory question.
