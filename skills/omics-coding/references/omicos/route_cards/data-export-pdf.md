...
- Source raw material: `../raw_skills/data-export-pdf/SOURCE.md`
- Domain: `export`
- Route role: `glue_helper`
- Object route: `report_assets`
- Primary authority: project output contract and library docs
- Official confirmation: `not_core_analysis`
...
Export only; use academic-html-report for scientific HTML closeout when required.
