...
- Source raw material: `../raw_skills/single-cell-monocle2-trajectory/SOURCE.md`
- Domain: `trajectory`
- Route role: `route_card`
- Object route: `annotated_anndata`
- Primary authority: OmicVerse function docs and Monocle official docs
...
Root state and branch definition must be biologically justified.
