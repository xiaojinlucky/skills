...
- Source raw material: `../raw_skills/microbiome-da-comparison/SOURCE.md`
- Domain: `microbiome_differential_abundance`
- Route role: `route_card`
- Object route: `microbiome_anndata`
- Primary authority: OmicVerse function docs and DA method official docs
...
Zero inflation and compositionality can change which method is defensible.
