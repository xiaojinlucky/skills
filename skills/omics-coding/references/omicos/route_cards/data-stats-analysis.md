...
- Source raw material: `../raw_skills/data-stats-analysis/SOURCE.md`
- Domain: `generic_statistics`
- Route role: `fallback_only`
- Object route: `generic_table`
- Primary authority: analysis package docs or statistical library docs after native gap
...
Generic stats must not replace package-native differential or enrichment methods.
