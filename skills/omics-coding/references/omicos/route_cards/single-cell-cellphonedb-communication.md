...
- Source raw material: `../raw_skills/single-cell-cellphonedb-communication/SOURCE.md`
- Domain: `cell_cell_communication`
- Route role: `route_card`
- Object route: `annotated_anndata`
- Primary authority: OmicVerse function docs and CellPhoneDB official docs
...
Communication results are inference from expression; require sender/receiver and visualization semantics.
