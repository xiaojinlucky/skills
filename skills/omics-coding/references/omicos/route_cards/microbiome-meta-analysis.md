...
- Source raw material: `../raw_skills/microbiome-meta-analysis/SOURCE.md`
- Domain: `microbiome_meta_analysis`
- Route role: `route_card`
- Object route: `multi_cohort_microbiome_results`
- Primary authority: OmicVerse function docs and meta-analysis method docs
...
Cohort heterogeneity must be reported, not averaged away.
