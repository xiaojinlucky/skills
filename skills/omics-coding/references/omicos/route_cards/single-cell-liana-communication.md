...
- Source raw material: `../raw_skills/single-cell-liana-communication/SOURCE.md`
- Domain: `cell_cell_communication`
- Route role: `route_card`
- Object route: `annotated_anndata`
- Primary authority: OmicVerse function docs and LIANA official docs
...
LIANA score semantics and OmicVerse wrapper parameters must be read before plotting.
