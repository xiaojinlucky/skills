...
- Source raw material: `../raw_skills/single-popv-annotation/SOURCE.md`
- Domain: `population_level_annotation`
- Route role: `route_card`
- Object route: `query_anndata_plus_reference_or_hub`
- Primary authority: OmicVerse function docs and PopV official docs
...
Consensus labels need reference provenance and confidence inspection.
