...
- Source raw material: `../raw_skills/bulk-deseq2-analysis/SOURCE.md`
- Domain: `bulk_differential_expression`
- Route role: `route_card`
- Object route: `bulk_count_matrix`
- Primary authority: OmicVerse/SCOP function docs and PyDESeq2 official docs
...
Confirm raw counts, contrast, design, and independent filtering behavior.
