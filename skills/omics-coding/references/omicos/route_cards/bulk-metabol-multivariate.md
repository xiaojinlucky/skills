...
- Source raw material: `../raw_skills/bulk-metabol-multivariate/SOURCE.md`
- Domain: `metabolomics_multivariate`
- Route role: `route_card`
- Object route: `metabolomics_anndata`
- Primary authority: OmicVerse function docs and metabolomics method docs
...
PLS/OPLS can overfit; require nested validation or permutation when used for claims.
