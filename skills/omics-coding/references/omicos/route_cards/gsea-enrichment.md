...
- Source raw material: `../raw_skills/gsea-enrichment/SOURCE.md`
- Domain: `enrichment`
- Route role: `route_card`
- Object route: `ranked_gene_list_or_deg_table`
- Primary authority: OmicVerse/SCOP function docs and gene set database docs
...
Gene ID space, ranking statistic, and gene set source must be checked.
