...
- Source raw material: `../raw_skills/single-cell-scenic/SOURCE.md`
- Domain: `gene_regulatory_network`
- Route role: `route_card`
- Object route: `single_cell_anndata_plus_motif_resources`
- Primary authority: OmicVerse function docs and SCENIC resource docs
...
Resource species, motif database, and GRN backend determine regulon credibility.
