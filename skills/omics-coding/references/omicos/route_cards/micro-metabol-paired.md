...
- Source raw material: `../raw_skills/micro-metabol-paired/SOURCE.md`
- Domain: `microbiome_metabolomics_integration`
- Route role: `route_card`
- Object route: `paired_microbiome_and_metabolomics_anndata`
- Primary authority: OmicVerse function docs and selected integration method docs
...
Sample pairing and modality-specific normalization must be verified before integration.
