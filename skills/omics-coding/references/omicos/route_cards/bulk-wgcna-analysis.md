...
- Source raw material: `../raw_skills/bulk-wgcna-analysis/SOURCE.md`
- Domain: `bulk_coexpression_network`
- Route role: `route_card`
- Object route: `bulk_expression_matrix_with_traits`
- Primary authority: OmicVerse/SCOP function docs and WGCNA official docs
...
Module-trait associations require sample-level design and multiple-testing handling.
