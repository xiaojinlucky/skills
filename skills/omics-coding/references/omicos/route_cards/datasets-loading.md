# OmicVerse built-in datasets and mock data

- Source raw material: `../raw_skills/datasets-loading/SOURCE.md`
- Domain: `demo_datasets`
- Route role: `glue_helper`
- Object route: `built_in_demo_dataset`
...
Demo datasets are for smoke tests, not a substitute for user data.
