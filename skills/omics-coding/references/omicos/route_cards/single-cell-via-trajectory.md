...
- Source raw material: `../raw_skills/single-cell-via-trajectory/SOURCE.md`
- Domain: `trajectory`
- Route role: `route_card`
- Object route: `anndata_with_optional_velocity`
- Primary authority: OmicVerse function docs and VIA official docs
...
VIA terminal states and velocity weighting need explicit sensitivity checks.
