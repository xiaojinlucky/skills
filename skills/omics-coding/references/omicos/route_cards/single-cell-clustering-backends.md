...
- Source raw material: `../raw_skills/single-cell-clustering-backends/SOURCE.md`
- Domain: `single_cell_clustering`
- Route role: `route_card`
- Object route: `prepared_anndata_embedding`
...
Clustering resolution and embedding choice must be tied to the question.
