...
- Source raw material: `../raw_skills/bulk-metabol-pathway-multifactor/SOURCE.md`
- Domain: `metabolomics_pathway_multifactor`
- Route role: `route_card`
- Object route: `metabolomics_anndata`
- Primary authority: OmicVerse function docs and pathway database docs
...
Pathway and multifactor claims need metadata design checked before analysis.
