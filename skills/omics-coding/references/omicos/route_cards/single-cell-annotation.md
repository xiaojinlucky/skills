...
- Source raw material: `../raw_skills/single-cell-annotation/SOURCE.md`
- Domain: `single_cell_annotation`
- Route role: `route_card`
- Object route: `annotated_or_clustered_anndata`
- Primary authority: OmicVerse/SCOP function docs and backend official docs
...
Automated labels need marker-level sanity checks before biological claims.
