...
- Source raw material: `../raw_skills/single-cell-lda-topic-clustering/SOURCE.md`
- Domain: `topic_model_clustering`
- Route role: `route_card`
- Object route: `count_like_anndata`
- Primary authority: OmicVerse function docs and MIRA official docs
...
Topic number and count scale must be checked before interpreting topics.
