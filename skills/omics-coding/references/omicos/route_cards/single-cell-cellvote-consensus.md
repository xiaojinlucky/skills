...
- Source raw material: `../raw_skills/single-cell-cellvote-consensus/SOURCE.md`
- Domain: `single_cell_annotation_consensus`
- Route role: `route_card`
- Object route: `multiple_annotation_results`
- Primary authority: OmicVerse function docs and annotator backend docs
...
Consensus can hide systematic annotator bias; inspect disagreements.
