...
- Source raw material: `../raw_skills/bulk-celltype-deconvolution/SOURCE.md`
- Domain: `bulk_deconvolution`
- Route role: `route_card`
- Object route: `bulk_matrix_plus_single_cell_reference`
- Primary authority: OmicVerse/SCOP function docs and selected backend official docs
...
Backend choice changes assumptions; confirm paired reference and output fraction semantics.
