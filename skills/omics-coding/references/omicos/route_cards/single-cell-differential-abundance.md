...
- Source raw material: `../raw_skills/single-cell-differential-abundance/SOURCE.md`
- Domain: `single_cell_differential_abundance`
- Route role: `route_card`
- Object route: `annotated_anndata_with_samples`
...
Use sample-level design; pooled cells are not biological replicates.
