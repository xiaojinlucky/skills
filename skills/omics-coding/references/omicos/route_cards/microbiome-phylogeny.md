...
- Source raw material: `../raw_skills/microbiome-phylogeny/SOURCE.md`
- Domain: `microbiome_phylogeny`
- Route role: `route_card`
- Object route: `asv_sequences_or_asv_table`
- Primary authority: OmicVerse function docs and phylogeny tool docs
...
Tree-aware metrics require a valid ASV tree linked to the same features.
