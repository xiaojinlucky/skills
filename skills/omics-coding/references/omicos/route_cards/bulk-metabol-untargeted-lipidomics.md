...
- Source raw material: `../raw_skills/bulk-metabol-untargeted-lipidomics/SOURCE.md`
- Domain: `metabolomics_lipidomics`
- Route role: `route_card`
- Object route: `mz_rt_or_lipidomics_feature_table`
- Primary authority: OmicVerse function docs and metabolomics database docs
...
Annotation confidence and adduct matching must not be reported as definitive identity.
