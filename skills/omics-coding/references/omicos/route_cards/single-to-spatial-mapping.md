...
- Source raw material: `../raw_skills/single-to-spatial-mapping/SOURCE.md`
- Domain: `single_to_spatial_mapping`
- Route role: `route_card`
- Object route: `single_cell_reference_plus_spatial_object`
- Primary authority: OmicVerse/SCOP function docs and selected mapping method docs
...
Spot/cell resolution and marker validation must be checked before spatial claims.
