...
- Source raw material: `../raw_skills/single-cell-rna-velocity/SOURCE.md`
- Domain: `rna_velocity`
- Route role: `route_card`
- Object route: `spliced_unspliced_anndata`
- Primary authority: OmicVerse function docs and velocity backend official docs
...
Velocity requires compatible layers and model assumptions; do not infer direction without checks.
