...
- Source raw material: `../raw_skills/bulk-deg-analysis/SOURCE.md`
- Domain: `bulk_differential_expression`
- Route role: `route_card`
- Object route: `bulk_expression_matrix`
- Primary authority: OmicVerse/SCOP function docs and DESeq2 or PyDESeq2 official docs
...
Do not mix normalized and count-scale inputs without confirming method requirements.
