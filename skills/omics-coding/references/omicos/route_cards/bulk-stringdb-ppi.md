...
- Source raw material: `../raw_skills/bulk-stringdb-ppi/SOURCE.md`
- Domain: `ppi_network`
- Route role: `route_card`
- Object route: `gene_or_protein_list`
- Primary authority: OmicVerse/SCOP function docs and STRING official docs
...
STRING edges are database evidence, not direct experimental proof for this dataset.
