...
- Source raw material: `../raw_skills/single-cell-cellmatch-ontology/SOURCE.md`
- Domain: `cell_ontology_mapping`
- Route role: `route_card`
- Object route: `cell_type_labels`
- Primary authority: OmicVerse function docs and Cell Ontology source docs
...
Ontology mapping standardizes labels; it does not validate the original annotation.
