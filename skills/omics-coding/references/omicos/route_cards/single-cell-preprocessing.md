...
- Source raw material: `../raw_skills/single-cell-preprocessing/SOURCE.md`
- Domain: `single_cell_preprocessing`
- Route role: `route_card`
- Object route: `raw_or_loaded_anndata`
...
QC thresholds, normalization, HVG, PCA, neighbors, and clustering must be planned before running.
