...
- Source raw material: `../raw_skills/spatial-tutorials/SOURCE.md`
- Domain: `spatial_transcriptomics`
- Route role: `route_card`
- Object route: `visium_hd_stereo_slideseq_or_spatial_anndata`
- Primary authority: OmicVerse/SCOP function docs and platform official docs
...
Platform geometry, image registration, deconvolution, and native plotting route must be confirmed.
