...
- Source raw material: `../raw_skills/single-cell-cnmf-program-discovery/SOURCE.md`
- Domain: `gene_program_discovery`
- Route role: `route_card`
- Object route: `normalized_single_cell_anndata`
- Primary authority: OmicVerse function docs and cNMF method docs
...
Program number and stability must be checked before naming gene programs.
