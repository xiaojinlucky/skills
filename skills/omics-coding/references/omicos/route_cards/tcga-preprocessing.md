...
- Source raw material: `../raw_skills/tcga-preprocessing/SOURCE.md`
- Domain: `tcga_preprocessing`
- Route role: `route_card`
- Object route: `tcga_expression_and_clinical_archives`
- Primary authority: OmicVerse function docs and GDC/TCGA official docs
...
Sample barcode handling and clinical endpoint definitions must be verified.
