...
- Source raw material: `../raw_skills/single-cell-trajectory-inference/SOURCE.md`
- Domain: `trajectory`
- Route role: `route_card`
- Object route: `cluster_ready_anndata`
...
Branch method choice must match topology and biological starting point.
