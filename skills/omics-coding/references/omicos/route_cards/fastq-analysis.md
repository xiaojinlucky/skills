# FASTQ analysis and RNA-seq alignment with omicverse

- Source raw material: `../raw_skills/fastq-analysis/SOURCE.md`
- Domain: `fastq_alignment`
- Route role: `route_card`
- Object route: `sra_fastq_reference_genome`
- Primary authority: OmicVerse function docs and aligner official docs
...
Raw FASTQ workflows require reference genome, chemistry, and output matrix contract.
