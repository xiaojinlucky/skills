...
- Package: scop
- Language: R
- Function: `ComBat_integrate`
- Source: https://mengxu98.github.io/scop/reference/ComBat_integrate.html
- Raw source: https://raw.githubusercontent.com/mengxu98/scop/main/man/ComBat_integrate.Rd
...
- `ComBat_params`: A list of parameters for the sva::ComBat function. Default is `list()`.
