...
- Package: scop
- Language: R
- Function: `LIGER_integrate`
- Source: https://mengxu98.github.io/scop/reference/LIGER_integrate.html
- Raw source: https://raw.githubusercontent.com/mengxu98/scop/main/man/LIGER_integrate.Rd
...
- `liger_dims_use`: A vector specifying the dimensions returned by LIGER that will be utilized for downstream cell cluster finding and nonlinear reduction. If set to NULL, all the returned dimensions will be used by default.
...
- `optimizeALS_params`: A list of parameters for the [rliger:runIntegration]{rliger::runIntegration} function. Default is list().
- `quantilenorm_params`: A list of parameters for the [rliger:quantileNorm]{rliger::quantileNorm} function. Default is list().
