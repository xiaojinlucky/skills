...
- Package: scop
- Language: R
- Function: `Seurat_integrate`
- Source: https://mengxu98.github.io/scop/reference/Seurat_integrate.html
- Raw source: https://raw.githubusercontent.com/mengxu98/scop/main/man/Seurat_integrate.Rd
...
- `FindIntegrationAnchors_params`: A list of parameters for the Seurat::FindIntegrationAnchors function. Default is `list()`.
- `IntegrateData_params`: A list of parameters for the Seurat::IntegrateData function. Default is `list()`.
- `IntegrateEmbeddings_params`: A list of parameters for the Seurat::IntegrateEmbeddings function. Default is `list()`.
