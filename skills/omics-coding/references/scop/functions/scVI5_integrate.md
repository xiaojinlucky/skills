...
- Package: scop
- Language: R
- Function: `scVI5_integrate`
- Source: https://mengxu98.github.io/scop/reference/scVI5_integrate.html
- Raw source: https://raw.githubusercontent.com/mengxu98/scop/main/man/scVI5_integrate.Rd
...
- `scVI_dims_use`: A vector specifying the integrated dimensions used for downstream clustering and nonlinear reduction.
...
- `cores`: Number of DataLoader worker processes for scVI training. NULL (default) uses the PyTorch default (0, single-process). Increase to speed up data loading on multi-core machines.
- `IntegrateLayers_params`: A list of parameters passed to [Seurat::IntegrateLayers].
