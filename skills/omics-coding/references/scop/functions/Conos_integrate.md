...
- Package: scop
- Language: R
- Function: `Conos_integrate`
- Source: https://mengxu98.github.io/scop/reference/Conos_integrate.html
- Raw source: https://raw.githubusercontent.com/mengxu98/scop/main/man/Conos_integrate.Rd
...
- `buildGraph_params`: A list of parameters for the buildGraph function. Default is `list()`.
- `cores`: An integer setting the number of threads for `Conos`. Default is `2`.
